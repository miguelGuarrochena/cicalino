...
import { EmpleadosLista } from "@/components/local/EmpleadosLista";
import {
  useConfigStore,
...
const ConfigPage = () => {
  ...
  if (rol === "empleado" || rol === "superadmin") return <SinAcceso />;
