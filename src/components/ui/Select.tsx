...
interface Props {
  ...
  className?: string;
  /** Clase del botón trigger (además del estilo de variante). */
  triggerClassName?: string;
  ariaLabel?: string;
  disabled?: boolean;
  placeholder?: string;
  /** `field` = formularios; `pill` = header compacto. */
  variant?: Variant;
}
...
/**
 * Dropdown custom (sin `<select>` nativo). Menú en portal para no cortarse
 * dentro de modales con overflow.
 */
export const Select = ({
  value,
  onChange,
