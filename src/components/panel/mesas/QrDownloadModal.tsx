    ...
    >
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <button
          ...
          disabled={busy}
          onClick={() => onPick("solo")}
          className="flex flex-col gap-3 rounded-[20px] border-2 border-linea bg-surface p-3 text-left transition hover:border-marca disabled:opacity-50"
        >
          <div className="flex aspect-square items-center justify-center rounded-2xl bg-white p-4 ring-1 ring-linea">
        ...
        <button
          ...
          className="flex flex-col gap-3 rounded-[20px] border-2 border-linea bg-surface p-3 text-left transition hover:border-marca disabled:opacity-50"
        >
          <div className="flex aspect-[3/4] flex-col items-center rounded-2xl border-2 border-dashed border-gray-400 bg-white px-3 py-3 text-center">
