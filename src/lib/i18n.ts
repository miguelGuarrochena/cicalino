  ...
  es: {
    ...
    home: {
      ...
      walk: {
        ...
        titulo: "Así se siente",
        cerrar: "Cerrar",
        prev: "Anterior",
        next: "Siguiente",
        push: "¡Tu pedido 42 está listo!",
        scan: "Escaneás el QR con la cámara. Sin descargar apps.",
        espera: "Queda la pantalla abierta mientras preparan tu pedido.",
        aviso: "Llega el aviso al celular: ya podés retirar.",
        listo: "Vas al mostrador y te lo llevás. Simple.",
      },
    },
    entrar: {
      titulo: "Entrar",
      ...
      adminDet: "Config, empleados, métricas y pedidos.",
      supervisor: "Supervisor",
      supervisorDet: "Pedidos, personal y modo. Sin métricas.",
      empleado: "Empleado",
    ...
    cliente: {
      ...
      preparandoSub: "Te avisamos apenas esté listo. No cierres esta pantalla.",
    ...
    super: {
      titulo: "Superadmin",
      subtitulo: "Locales de Cicalino",
      alta: "Alta de local",
      detalle: "Detalle del local",
      editar: "Editar",
      guardar: "Guardar",
      eliminar: "Eliminar",
      confirmarEliminar: "Sí, eliminar",
      modalSub: "Datos del negocio y del responsable fiscal.",
      formError: "Completá nombre, responsable y un email válido.",
      ...
      tipo: "Tipo",
      emailAdmin: "Email del dueño (admin)",
      responsable: "Responsable",
      cuil: "CUIL / CUIT",
      direccion: "Dirección",
      crear: "Crear local",
      localesActivos: "Locales activos",
      totalPedidos: "Pedidos hoy",
      ...
      pausar: "Pausar",
      activar: "Activar",
      sinLocales: "Todavía no hay locales.",
      mrr: "Ingreso mensual",
      morosos: "Impagos",
      plan: "Plan",
      pagado: "Pagado",
  ...
  en: {
    ...
    home: {
      ...
      walk: {
        ...
        scan: "Scan the QR with the camera. No app download.",
        espera: "Keep the screen open while your order is prepared.",
        aviso: "A notice hits the phone: time to pick it up.",
        listo: "Head to the counter and grab it. Simple.",
      },
    },
    entrar: {
      titulo: "Sign in",
      ...
      adminDet: "Settings, staff, metrics and orders.",
      supervisor: "Supervisor",
      supervisorDet: "Orders, staff and ID mode. No metrics.",
      empleado: "Staff",
    ...
    cliente: {
      ...
      preparandoSub: "We'll let you know the moment it's ready. Keep this screen open.",
    ...
    super: {
      titulo: "Superadmin",
      subtitulo: "Cicalino businesses",
      alta: "Add business",
      detalle: "Business details",
      editar: "Edit",
      guardar: "Save",
      eliminar: "Delete",
      confirmarEliminar: "Yes, delete",
      modalSub: "Business and tax contact details.",
      formError: "Fill in name, contact person and a valid email.",
      errNombre: "Name is required.",
      errResponsable: "Contact person is required.",
      errEmail: "Invalid email.",
      errCuil: "Invalid tax ID (11 digits).",
      errDireccion: "Address is required.",
      nombreLocal: "Business name",
      tipo: "Type",
      emailAdmin: "Owner email (admin)",
      responsable: "Contact person",
      cuil: "Tax ID (CUIL/CUIT)",
      direccion: "Address",
      crear: "Create business",
      localesActivos: "Active businesses",
      totalPedidos: "Orders today",
      ingresos: "Estimated revenue",
      estado: "Status",
      activo: "Active",
      pausado: "Paused",
      pausar: "Pause",
      activar: "Activate",
      sinLocales: "No businesses yet.",
      mrr: "Monthly revenue",
      morosos: "Overdue",
      plan: "Plan",
      pagado: "Paid",
