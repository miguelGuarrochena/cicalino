  ...
  es: {
    ...
    ayuda: {
      ...
      espera: {
        ...
        p5t: "Reservas",
        p5d: "«+ Reserva»: nombre, personas, mesas, horario y minutos de gracia. La mesa NO se bloquea: la seguís usando hasta la hora. En el mapa se ve el horario de la reserva y, si sentás gente ahí, la app te avisa antes.",
        p6t: "Walk-in / ocupar",
  ...
  en: {
    ...
    ayuda: {
      ...
      espera: {
        ...
        p5t: "Reservations",
        p5d: "“+ Reservation”: name, party size, tables, time and grace minutes. The table is NOT blocked — you keep using it until then. The map shows the booking time, and you get a warning before seating anyone there.",
        p6t: "Walk-in / occupy",
