...
const dict = {
  es: {
    ...
    config: {
      ...
      guardarEmp: "Agregar",
      modalSub: "Nombre + PIN. Al fichar solo ven Pedidos/Espera; el dueño sale del fichaje para Config.",
  ...
  en: {
    ...
    config: {
      ...
      guardarEmp: "Add",
      modalSub: "Name + PIN. Clocked-in staff only see Orders/Wait; owner clocks out for Settings.",
