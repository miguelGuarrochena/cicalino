  ...
  es: {
    ...
    ayuda: {
      ...
      general: {
        ...
        p2t: "Sonido",
        p2d: "El ícono de sonido es del mostrador (PC/tablet). Activálo: suena un beep de prueba. Después avisa al crear un pedido, marcar listo o si un cliente cancela una espera. La vibración solo en teléfonos.",
  ...
  en: {
    ...
    ayuda: {
      ...
      general: {
        ...
        p2t: "Sound",
        p2d: "The sound icon is for the counter (PC/tablet). Turn it on: you’ll hear a test beep. Then it alerts on new orders, marking ready, or when a guest cancels a wait. Vibration is phones only.",
        p3t: "Switch branch",
