  ...
  es: {
    ...
    ayuda: {
      ...
      espera: {
        ...
        p5t: "Reservas",
        p5d: "«+ Reserva»: nombre, personas, mesas, horario y minutos de gracia. La mesa queda reservada hasta que los sentás, cancelás o expira la gracia.",
        p6t: "Walk-in / ocupar",
  ...
  en: {
    ...
    ayuda: {
      ...
      espera: {
        ...
        p5t: "Reservations",
        p5d: "“+ Reservation”: name, party size, tables, time and grace minutes. The table stays reserved until you seat them, cancel, or grace expires.",
        p6t: "Walk-in / occupy",
